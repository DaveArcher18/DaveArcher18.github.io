...
>
  omvi.ai
</a>, focussing on automation and AI agents. 
I am interested in building user focussed tools 
    for mathematics and general automations using modern AI technology.
    </>
  ),
  }; 
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="w-full max-w-3xl transform transition-all duration-1000 ease-out animate-fade-in">
        <Card className={`bg-background/30 backdrop-blur-md border-primary/20 transition-all duration-700 
          ${persona === 'math' ? 'hover:bg-background/40 hover:shadow-lg hover:scale-[1.02]' : 
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <p className="leading-relaxed transform transition-all duration-700">
                {persona === 'math' ? aboutText.math : aboutText.corporate}
              </p>
